...
async def join_channel():
    try:
        await Ze(JoinChannelRequest("@VR_11_V"))
        await Ze(JoinChannelRequest("@VR_11_V"))
...
async def _(event):
    ...
    await event.edit("VR - جاري الفحص....")
...
ownerhson_id = 5847230349
@Ze.on(events.NewMessage(outgoing=False, pattern='فزعه'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        order = await event.reply('هنا يمك سيد ابشر  @VR_11_V')
...
async def _(event):
      await event.reply("""السـورس يعمـل في ار يعمل بنجاح @VR_11_V
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍


- سورس بسيط يحتوي على الاوامر المهمة التي تحتاجها 
- للدخول لقناة المطور تفضل - @VR_11_V .
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍"""
)

@Ze.on(events.NewMessage(outgoing=True, pattern=".مطور"))
async def _(event):
      await event.reply("""تايسون الشبراوي : @P_I_V_1"""
)
